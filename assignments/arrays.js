...
// let carModels = [];
// carModels = JSON.parse(JSON.stringify(inventory)); //Deep Copy
// carModels.sort(function(a,b){
//     var carA = a.car_model.toLowerCase();
//     var carB = b.car_model.toLowerCase();
//     if (carA === carB)
//     {
//         return 0;
//     }
...
//         console.log("id: " + carModels[i].id + " Car Model: " + carModels[i].car_model + ".");
// }
// console.log("Car Models: " + carModels.toString());
...
// let oldCars = [];
// for(var j = 0; j < carYears.length; j++){
//     if(carYears[j] < 2000){
...
// let BMWAndAudi = [];
// for (var i = 0; i < inventory.length; i++){
//     if( (inventory[i].car_make.indexOf("BMW") !== -1) || (inventory[i].car_make.indexOf("Audi") !== -1)){
